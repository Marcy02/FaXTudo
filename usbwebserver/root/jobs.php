      ...
      <div class="dropdown-container">
         ...
         <div class="dropdown">
            ...
            <div class="lists">
               ...
               <p class="items">20 mil - 50 mil</p>
               <p class="items">50 mil - 1 milhão</p>
               <p class="items">1 milhão - 5 milhões</p>
               <p class="items">5 milhões - 10 milhões</p>
               <p class="items">10 milhões ou mais</p>
            </div>
         </div>
         <div class="dropdown">
