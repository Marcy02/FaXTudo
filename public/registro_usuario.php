...
<div class="account-form-container">
   ...
   <section class="account-form">
      ...
      <form action="incluir_usuario.php" method="post">
         ...
         <input type="text" required name="cnpj_cpf" maxlength="11" placeholder="CNPJ/CPF" class="input">
         ...
         <input type="submit" value="Registrar" name="btn-cadastrar" class="btn btn-success">
      </form>
