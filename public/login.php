...
<div class="account-form-container">
	<section class="account-form">
		<form action="login.php" method="post">
			<h3>Bem-vindo!</h3>
			<!-- <input type="text" required name="cnpj_cpf" maxlength="50" placeholder="Entre com seu CNPJ/CPF" class="input"> -->
			<?php if (!is_null($error)): ?>
				<div class="alert alert-danger" role="alert">
					<?php echo $error; ?>
				</div>
			<?php endif; ?>
			<input type="text" name="cnpj_cpf" class="form-control m-1" placeholder="Digite o seu CNPJ/CPF" required>
