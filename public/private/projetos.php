                ...
                <?php else: ?>
                    <?php foreach ($cargos as $nome => $dados): ?>
                        <tr>
                            ...
                            <td><?php echo $dados[0]['requerimentos']; ?></td>
                            <td>
                            ...
                            <td>
                                <div class="d-inline-flex">
                                    <button type="button" class="btn btn-info mr-2" data-toggle="modal" data-target="#exampleModal" onclick="preencherModal('<?php echo implode(',', $dados[0]); ?>')">Alterar Projeto</button>
                                    <form action="painel.php" method="POST">
                                        <input type="hidden" name="idEmprego" value="<?php echo $dados[0]['id_job']; ?>">
                                        <input type="hidden" name="remover" value="1">
                                        <button type="submit" class="btn btn-danger mr-2">Remover Projeto</button>
                                    </form>
                                </div>
                            </td>
                        </tr>
