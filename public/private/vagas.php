						...
						<?php else: ?>
							<?php foreach($result->fetch_all() as $vaga): ?>
								<tr>
									...
									<td>
										<button type="button" class="btn btn-outline-info btn-lg" data-toggle="modal" data-target="#exampleModal" onclick="preencherModal('<?php echo implode(',', $vaga); ?>')">Visualizar</button>
									</td>
								</tr>
							<?php endforeach; ?>
						<?php endif; ?>
...
<div class="modal fade fs-5" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
