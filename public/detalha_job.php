...
<section class="job-details">
   ...
   <div class="details">
      <div class="job-info">
         ...
         <h3><?php echo  $linha['cat_cargo'];?></h3>
         <br>

         <h5>Salário:</h5>
         <h3><?php echo  $linha['salario'];?></h3>
         <br>

         <h5>Jornada:</h5>
         <h3><?php echo  $linha['jornada'];?></h3>
         <br>

         <h5>Turno:</h5>
         <h3><?php echo  $linha['turno'];?></h3>
         <br>

         <h5>Requirementos:</h5>
         <h3><?php echo  $linha['requerimentos'];?></h3p>
         <br>

         <h5>Qualificação Mínima:</h5>
         <h3><?php echo  $linha['qualificacao_min'];?></h3>
         <br>

         <h5>Habilidades:</h5>
         <h3><?php echo  $linha['habilidades'];?></h3>
         <br>

         <h5>Descrição do Cargo</h5>
         <h3><?php echo  $linha['desc_cargo'];?></h3>
         <br>
