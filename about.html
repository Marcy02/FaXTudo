...
<section class="about">
   ...
   <div class="box">
      ...
      <p>Esteja você procurando um profissional para um projeto único ou buscando parcerias de longo prazo, nosso sistema foi projetado com você em mente.</p>
      <a href="contact.html" class="btn">Contate-nos</a>
   </div>

</section>

<!-- about us section termina -->

<!-- reviews section começa  -->

<div class="section-title">Avaliações e Feedback</div>
...
<section class="reviews">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3 class="title">super resultados</h3>
         <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Odio eum cumque dolor, quisquam perspiciatis consequatur!</p>
         <div class="user">
